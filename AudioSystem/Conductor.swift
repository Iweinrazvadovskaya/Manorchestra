...
class Conductor {
    ...
    private func setupSampler() {
        ...
        sampler.sustainLevel = 0.7
        sampler.releaseDuration = 0.4
        sampler.masterVolume = 1.2
...
//        sampler.filterReleaseDuration = 10.0
    ...
    func loadPianoSamples() {
        let fileURL = Bundle.main.url(forResource: "Piano1", withExtension: "sf2")!
        sampler.loadSFZ(path: fileURL.deletingLastPathComponent().absoluteString, fileName: "Piano1.sf2")
    }
